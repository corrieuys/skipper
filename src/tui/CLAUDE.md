...
| `render/widgets.ts` | Shared drawing helpers: panel, pills, phase strip, sparkline, scrollbar, key hints, dim backdrop, shadow, `orb` (agent presence: pulsing ● working, ○ resting; the task pane and feed roster share it) |
