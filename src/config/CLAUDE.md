...
| `model-settings.ts` | Machine-scoped provider+model overrides (config page "Agent Models"): skipper, chat, greg, dictation (experimental). `PROVIDER_ALLOWLIST` gates which agent types are selectable |
