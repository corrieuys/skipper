...
| file | use |
|---|---|
| `queries.ts` | Big bag of typed query fns. Tasks, forensics, agents, teams, escalations, dashboard (running instances, metrics, recent activity, poll interval, daemon-paused) |
