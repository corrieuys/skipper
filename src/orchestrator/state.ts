...
export const TRANSITIONS: Record<TaskOrchStep, readonly TaskOrchStep[]> = {
  IDLE: ["AGENT_RUNNING", "RECOVERING", "PAUSING"],
  AGENT_RUNNING: ["WAITING_DELEGATION", "WAITING_CONSENSUS", "ADVANCING_PHASE", "REGRESSION", "WAITING_ESCALATION", "PAUSING", "IDLE"],
  WAITING_DELEGATION: ["AGENT_RUNNING", "WAITING_ESCALATION", "PAUSING", "IDLE"],
  WAITING_CONSENSUS: ["AGENT_RUNNING", "WAITING_ESCALATION", "PAUSING", "IDLE"],
  ADVANCING_PHASE: ["AGENT_RUNNING", "WAITING_ESCALATION", "PAUSING", "IDLE"],
  REGRESSION: ["AGENT_RUNNING", "WAITING_ESCALATION", "PAUSING", "IDLE"],
  WAITING_ESCALATION: ["AGENT_RUNNING", "PAUSING", "IDLE"],
  PAUSING: ["PAUSED"],
  PAUSED: ["RECOVERING", "IDLE"],
  RECOVERING: ["AGENT_RUNNING", "PAUSING", "IDLE"],
};
